      ...
      <footer className={`ft-root ${visible ? 'visible' : ''}`} ref={footerRef}>
        ...
        <div className="ft-bottom">
          ...
          <div className="ft-bottom-links">
            ...
            <NavLink to="#" className="ft-bottom-link">Privacy</NavLink>
            <NavLink to="#" className="ft-bottom-link">Cookies</NavLink>
            <NavLink to="#" className="ft-bottom-link">Security</NavLink>
          </div>
